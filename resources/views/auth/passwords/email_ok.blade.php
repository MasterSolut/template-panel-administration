  ...
  <div class="login-box-body">
     @if(Session::has('flash_message'))
      ...
      <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
        <input type="hidden" class="form-control" value="{{$utilisateurs->id_users}}" placeholder="" value="" name="id_users" autocomplete="off">
      </div>
...
<a href="{{url('password_edit/'.$utilisateurs->id_users)}}" class="btn btn-primary">Suivant</a>
