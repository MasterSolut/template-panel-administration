...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('../resources/assets/fancybox/jquery.fancybox.css?v=2.1.5) }}"/>  -->
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs- text-center">
                    <!-- <a href="#">Followers</a> -->
                    <a href="javascript:openwindows('{{url('password_edit/'.Auth::user()->id_users)}}',500,400,true)" class="">Changer mot de passe</a>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="javascript:openwindows('{{route('utilisateurs.edit',Auth::user()->id_users)}}',990,550,true)" class="btn btn-default btn-flat">Profile</a>
                </div>
...
<!-- Add fancyBox main JS and CSS files 
<script src="{{asset('../resources/assets/fancybox/jquery.fancybox.pack.js?v=2.1.5')}}"></script>
