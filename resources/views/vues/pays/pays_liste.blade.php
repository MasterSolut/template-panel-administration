...
<div class="box">
  <div class="box-header">
    ...
    <div class="box-header col-xs-2">
      <!-- /.box-header <a href="javascript:openwindows('{{ URL::To('pays/create')}}',500,480,true)"  class="btn btn-block btn-info">-->
      <a href="fancy_popup(('{{ URL::To('pays/create')}}',500,480,true)"  class="btn btn-block btn-info">
          ...
          <tbody>
           ...
           <tr role="row" class="odd">  
            ...
            <td>
              ...
              @if($pays->id_regions==$region->id_regions) {{$region->titre_regions}} @endif</td>
              @endforeach
